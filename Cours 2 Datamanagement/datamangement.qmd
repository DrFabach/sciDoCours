...
-   Permet d'interroger un logiciel sgbdr (système de gestion de base de données)
...
Quelle requête utiliser pour afficher les résultats d'histoire des étudiants qui ont u moins un resultats ?
