...
![Interpretability and Random Forests \| by Tom Grigg \| Towards Data Science](https://miro.medium.com/max/1200/1*RI9_LbQ5A9D1izBaU1ypzQ.gif){alt="Interpretability and Random Forests | by Tom Grigg | Towards Data Science"}
...
![](images/1%20AVtJDtXoBvhTSMtqzoYIvQ-1.gif)
...
-   Noyau polynomial: $$ K(\textbf{x}_i, \textbf{x}_j) = (\textbf{x}_i^T \textbf{x}_j + c)^d $$ où $c$ est des hyperparamètres de décalage et $d$ est le degré du polynôme.
...
![![machine learning](https://i0.wp.com/datascientest.com/wp-content/uploads/2020/05/kmeans-2.png?fit=377%252C368&ssl=1){alt="machine learning"}](https://i0.wp.com/datascientest.com/wp-content/uploads/2020/05/kmeans1.png?fit=377%252C368&ssl=1){alt="kmeans"}
