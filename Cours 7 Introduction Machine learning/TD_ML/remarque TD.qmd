...
rangeModel \<- preProcess(trainingSet, method = "range") trainingSetX \<- predict(rangeModel, newdata = trainingSet)

# Nomalizing test set as well.

rangeModel \<- preProcess(testSet, method = "range") testSetX \<- predict(rangeModel, newdata = testSet)

          Reference

Prediction Dead Alive Dead 221 35 Alive 0 3
