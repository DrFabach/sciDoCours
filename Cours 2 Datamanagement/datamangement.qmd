...
-   Permets d'interroger un logiciel sgbdr (système de gestion de base de
    données)
...
Utiliser les bases de données "pbcseq" et "pbc"
Transformer la table pbcseq au format long et réaliser une jointure entre les tables.
