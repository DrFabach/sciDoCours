...
-   Choix aléatoire des variables de chaques arbres

-   Idée : choisir la "meilleure" variable dans un ensemble réduit de
    variable

-   $mtry$ nombre de variable choisies alétoirement
...
-   **min.node.size** : nombre minimum de noeud par arbre / profondeur
    des arbres
